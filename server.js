...
app.get("/kurikulumWhereJoin/:lembagaPendidikan",kurikulumController.findKurukulumJoin);
...
app.post("/absensiWhereTanggalRekap",absensiController.findAbsensiByWhereTanggalRekap);
